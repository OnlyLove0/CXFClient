 ...
 * generated in the com.wdp.say package. 
...
public class ObjectFactory {
    ...
    private final static QName _Say_QNAME = new QName("http://wl.com/", "say");
    private final static QName _SayResponse_QNAME = new QName("http://wl.com/", "sayResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.wdp.say
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://wl.com/", name = "say")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://wl.com/", name = "sayResponse")
